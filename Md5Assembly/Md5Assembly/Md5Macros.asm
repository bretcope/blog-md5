...
Suffix macro rAd, rBd, sine, dataOffset, shift
    ...
    lea     r11d,[rAd+r10d+sine]                ; value = a + f + m + sine
    mov     rAd,r11d                            ; tmp1 = value
    shl     rAd,shift                           ; tmp1 = value << shift
    shr     r11d,(32-shift)                     ; tmp2 = value >> (32 - shift)
    or      rAd,r11d                            ; value = tmp1 | tmp2
